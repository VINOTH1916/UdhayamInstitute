...
function fetchTenthGradeStudents($conn) {
    ...
    $query = "SELECT student_id,roll_no, student_name FROM students WHERE std = '10'";
...
<body>
    <div class="container">
        <header>
            <h1>10th Grade Student Attendance</h1>
...
$sql = "SELECT COUNT(*) AS present_count FROM attend_10th WHERE date = '$currentDate' AND status = 'present'";
...
<a href="attendance.php" class="button">back</a>
