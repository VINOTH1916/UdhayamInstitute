...
$attendanceKey = "attend_art_11th_" . $currentDate;
...
function fetchEleventhGradeartStudents($conn) {
    $students = array(); 

    $query = "SELECT student_id,roll_no, student_name FROM students WHERE std = '11' AND name_of_grp = 'art'";
...
$eleventhGradeartStudents = fetchEleventhGradeartStudents($conn);
?>
...
<head>
    ...
    <title>Mark 11th Grade arts Student Attendance</title>
</head>

<body>
    <div class="container">
        <header>
            <h1>11th Grade arts Student Attendance</h1>
        </header>
        ...
        <form action="process_attendance_art_11th.php" method="POST"
...
$sql = "SELECT COUNT(*) AS present_count FROM attend_art_11th WHERE date = '$currentDate' AND status = 'present'";
...
?>
            ...
            <table>
                ...
                <tbody>
                    ...
                    foreach ($eleventhGradeartStudents as $student) {
                        echo '<tr>';
...
<a href="attend_sci_12th.php" class="button">12th science</a>
