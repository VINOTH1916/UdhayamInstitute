...
$attendanceKey = "attend_sci_11th_" . $currentDate;
...
function fetchEleventhGradeScienceStudents($conn) {
    ...
    $query = "SELECT student_id,roll_no, student_name FROM students WHERE std = '11' AND name_of_grp = 'sci'";
...
<body>
    <div class="container">
        <header>
            <h1>11th Grade Science Student Attendance</h1>
        </header>
        ...
        <form action="process_attendance_sci_11th.php" method="POST"
...
$sql = "SELECT COUNT(*) AS present_count FROM attend_sci_11th WHERE date = '$currentDate' AND status = 'present'";
